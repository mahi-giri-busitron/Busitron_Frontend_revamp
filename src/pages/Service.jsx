        ...
        <div className="bg-white px-6 py-12">
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                {services.map((service, index) => (
                    <div
                        key={index}
                        className="p-6 bg-gray-100 rounded-xl shadow-lg text-center transition-transform transform hover:scale-105"
                    >
            ...
            <div className=" w-fit flex flex-col items-center justify-center p-4 md:flex-row shadow-md rounded-l my-12">
                <div className="flex flex-col justify-center items-center lg:ml-[173px] md:flex-row gap-7 ">
                    ...
                    <div className="w-full h-auto md:w-1/2 flex items-center justify-center">
                        <video
