...
const Location = () => {
    ...
    return (
    <>
        <h1 className="text-3xl text-center font-bold md:my-5 md:mx-14 my-4 mx-10">
            Our Offices
        </h1>
        ...
        <section className="flex flex-col md:grid md:grid-cols-2 gap-14 md:mx-16 mx-10">
            ...
            <div className="flex flex-col sm:flex-col md:block">
                ...
                <div className="space-y-3 my-3">
                    ...
                    <p className="text-md font-serif">{item.ad1}</p>
                    <p className="text-md font-serif">{item.ad2}</p>
                    <p className="text-md">{item.ad3}</p>
