  ...
  return (
    <div className="p-5 bg-white shadow-md rounded-lg mb-1">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="block font-medium">Company Name <span className="text-red-600">*</span></label>
          <InputText
            value={company.name}
        ...
        <div>
          <label className="block font-medium">Company Email <span className="text-red-600">*</span></label>
          <InputText
            value={company.email}
        ...
        <div>
          <label className="block font-medium">Company Phone <span className="text-red-600">*</span></label>
          <InputText
            value={company.phone}
