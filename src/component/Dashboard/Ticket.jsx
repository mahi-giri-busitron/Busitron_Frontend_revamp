...
const Ticket = () => {
                    ...
                    <div className="absolute right-20 w-36 bg-white border shadow-md rounded-md z-10">
                        <ul className="py-1 text-sm text-gray-700">
                            <li
                                ...
                                onClick={() => alert(`Viewing ${rowData.ticketNo}`)}
                            >
                            ...
                            <li
                                className="px-4 py-2 cursor-pointer text-black hover:bg-gray-100 flex items-center"
                                onClick={() => alert(`Deleting ${rowData.ticketNo}`)}
                            >
                            ...
                            <li
                                className="px-4 py-2 cursor-pointer text-black hover:bg-gray-100 flex items-center"
                                onClick={() => alert(`Editing ${rowData.ticketNo}`)}
                            >
    ...
    const ticketSubjectTemplate = (rowData) => {
        ...
        return (
            <span className="truncate cursor-pointer" title={rowData.ticketSubject}>
                {truncatedText}
            </span>
        );
    };
        ...
        <div className="p-6 bg-gray-100 relative">
            <div className="flex flex-wrap justify-between items-center gap-4 mb-4">
                <div className="flex flex-wrap items-start">
                    <IconField iconPosition="left" className="h-10">
                        ...
                        <InputText placeholder="Search" className="h-10" />
                    </IconField>
                </div>
                ...
                <div className={`fixed top-20 right-0 z-40 w-66 h-screen p-4 overflow-y-auto bg-white shadow-lg transform transition-transform duration-300 ease-in-out ${showSidebar ? 'translate-x-0' : 'translate-x-full'}`}>
                <div className="flex justify-between items-center mb-4">
                    <h5 className="text-base font-semibold text-black uppercase">Filters</h5>
                    <button
                        type="button"
                ...
                <div className="overflow-y-auto h-[calc(90vh-9rem)]">
                    <div className="mb-6">
                        ...
                        <InputText placeholder="Nothing selected" className="w-54 h-10" />
                    </div>
                    <div className="mb-6">
                    ...
                    <div className="mb-6">
                        ...
                        <Dropdown options={priorities} placeholder="All" className="w-54 h-10 items-center" />
                    </div>
                    <div className="mb-6">
                        <label className="block text-sm font-medium text-gray-700 mb-1">Channel Name</label>
                        <Dropdown options={channels} placeholder="All" className="w-54 h-10 items-center" />
                    </div>
                    <div className="mb-6">
                        <label className="block text-sm font-medium text-gray-700 mb-1">Type</label>
                        <Dropdown options={types} placeholder="All" className="w-54 h-10 items-center" />
                    </div>
                    <div className="mb-6">
                        <label className="block text-sm font-medium text-gray-700 mb-1">Priority</label>
                        <Dropdown options={priorities} placeholder="All" className="w-54 h-10 items-center" />
                ...
                <div className="flex justify-end mt-4">
                    <Button label="Clear" outlined severity="secondary" className="w-24 h-10" />
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                {[
                    ...
                    <Card
                        key={index}
                        className="flex items-center justify-between shadow-md gap-4 w-50 h-28"
                    >
                        <div>
                            <p className="font-bold text-gray-600 text-sm mb-6">
                                {title}
                            </p>
                            <p className="text-md font-bold text-blue-500">0</p>
                        </div>
                    </Card>
                ))}
            </div>
            ...
            <div className="card">
                ...
                >
                    <Column field="sno" header="S.No" style={{ width: '10%' }} />
                    <Column field="ticketNo" header="Ticket" body={ticketNoTemplate} sortable style={{ width: '15%' }} />
                    <Column field="ticketSubject" header="Ticket Subject" body={ticketSubjectTemplate} style={{ width: '25%' }} />
                    <Column field="priority" header="Priority" style={{ width: '15%' }} />
                    <Column field="status" header="Status" body={statusTemplate} style={{ width: '15%' }} />
              ...
              <Dialog
                ...
                className="p-fluid"
            >
                <CreateTicket onHide={() => setShowCreateTicketModal(false)} />
            </Dialog>
        </div>
    );
};
